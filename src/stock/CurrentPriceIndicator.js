  ...
  if (this.hasInvalidationState(anychart.ConsistencyState.BOUNDS)) {
    ...
    if (this.label_.getFinalSettings('enabled')) {
      ...
      if (isNaN(labelPositionProvider['value']['x'])) {
        ...
        this.label_.autoAnchor(this.getOption('orientation') == anychart.enums.Orientation.LEFT ? anychart.enums.Anchor.RIGHT_CENTER : anychart.enums.Anchor.LEFT_CENTER);
      }
    } else {
      this.label_.clear();
      this.labelDisabled = true;
