...
anychart.color.getColor = function(colorName, normalizer, isHatchFill, canBeHoveredSelected, scrollerSelected, series, state, opt_ignorePointSettings, opt_ignoreColorScale, opt_baseColorName) {
  ...
  if (goog.isFunction(color)) {
    context = isHatchFill ?
        ...
        series.getColorResolutionContext(/** @type {acgraph.vector.Fill|acgraph.vector.Stroke} */(baseColor), opt_ignorePointSettings, opt_ignoreColorScale, anychart.core.defaultTheme.isDefaultFunction(color));
  ...
  if (stateColor) { // it is a function and not a hatch fill here
    context = series.getColorResolutionContext(
        ...
        opt_ignoreColorScale, anychart.core.defaultTheme.isDefaultFunction(stateColor));
